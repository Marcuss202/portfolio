                ...
                <div className="wrapper pl-2">
                    <div className="ContentBox m-3">
                        <div className="row d-flex"> 
                            <h3 className="col">Markuss Ozols</h3>
                            <div className="col contactWrapper d-flex justify-content-end gap-2">
                                <div onClick={() => copyToClipboard("markussozols25@gmail.com")} className="emailWrapper d-flex">
                                    <p className=" emailBio d-flex align-items-center">markussozols25@gmail.com</p>
                        ...
                        <div className="locationWrapper d-flex align-items-top gap-1">
